var SketchfabConfigurator = (function (e) {
  ...
  function (e, t, r) {
    ...
    (r(26).inspectSource = function (e) {
      ...
      (e.exports = function (e, t, r, s) {
        ...
        c && (o(r, "name") || a(r, "name", t)),
          e[t] !== r &&
            (c && (o(r, i) || a(r, i, e[t] ? "" + e[t] : u.join(String(t)))),
            e === n
              ? (e[t] = r)
              : s
              ? e[t]
      ...
      var n = r(40),
        ...
        Ie = function (e) {
          var t,
            ...
            h = O(s);
          if (void 0 != h && !S(h)) {
            for (i = h.call(s), n = [], t = 0; !(o = i.next()).done; t++)
              n.push(o.value);
            s = n;
          }
          for (
        ...
        je = function () {
          for (var e = 0, t = arguments.length, r = Fe(this, t); t > e; )
            r[e] = arguments[e++];
          return r;
        },
        De =
        ...
        Me = {
          ...
          filter: function (e) {
            return Oe(
              this,
              J(_e(this), e, arguments.length > 1 ? arguments[1] : void 0)
            );
          },
          find: function (e) {
          ...
          reverse: function () {
            for (
              var e, t = _e(this).length, r = Math.floor(t / 2), n = 0;
              n < r;
        ...
        Ve = function (e, t, r) {
          return !(Le(e, (t = y(t, !0))) && E(r) && P(r, "value")) ||
            P(r, "get") ||
            P(r, "set") ||
            r.configurable ||
            (P(r, "writable") && !r.writable) ||
            (P(r, "enumerable") && !r.enumerable)
            ? U(e, t, r)
            : ((e[t] = r.value), e);
        };
      ye || ((V.f = Ne), (N.f = Ve)),
        ...
        (e.exports = function (e, t, r, u) {
          ...
          P
            ? ((d = r(function (e, r, n, a) {
                ...
                if (E(r)) {
                  if (
                    ...
                    return Pe in r ? Re(d, r) : Ie.call(d, r);
                  (o = r), (p = xe(n, t));
                  var g = r.byteLength;
                  if (void 0 === a) {
                ...
                for (
                  h(e, "_d", { b: o, o: p, l: i, e: s, v: new W(o) });
                  f < s;
            ...
            : (o(function () {
              ...
              K(
                y !== Function.prototype ? F(g).concat(F(y)) : F(g),
                function (e) {
                  e in d || h(d, e, g[e]);
                }
              ),
          ...
          h(d, me, !0),
            ...
            i(i.P, c, Me),
            C(c),
            i(i.P + i.F * Se, c, { set: Ce }),
            i(i.P + i.F * !A, c, Te),
            n || S.toString == he || (S.toString = he),
            i(
              i.P +
                i.F *
                  o(function () {
      ...
      /*! https://mths.be/punycode v1.4.1 by @mathias */ !(function (o) {
        ...
        function F(e, t) {
          ...
          return (
            ...
            n + _((e = e.replace(P, ".")).split("."), t).join(".")
          );
        }
        function O(e) {
        ...
        function j(e) {
          ...
          for ((r = e.lastIndexOf(m)) < 0 && (r = 0), n = 0; n < r; ++n)
            e.charCodeAt(n) >= 128 && x("not-basic"), P.push(e.charCodeAt(n));
          for (a = r > 0 ? r + 1 : 0; a < w; ) {
            for (
              o = E, i = 1, s = c;
              a >= w && x("invalid-input"),
                ((h =
                  (y = e.charCodeAt(a++)) - 48 < 10
                    ? y - 22
                    : y - 65 < 26
                    ? y - 65
                    : y - 97 < 26
                  ...
                  x("overflow"),
                (E += h * i),
                !(h < (p = s <= _ ? l : s >= _ + f ? f : s - _));
              s += c
            )
              i > b(u / (g = c - p)) && x("overflow"), (i *= g);
            (_ = I(E - o, (t = P.length + 1), 0 == o)),
              b(E / t) > u - S && x("overflow"),
              (S += b(E / t)),
              (E %= t),
              P.splice(E++, 0, S);
          }
        ...
        function D(e) {
          var t,
            ...
            _,
            F = [];
          for (P = (e = O(e)).length, t = v, r = 0, o = d, i = 0; i < P; ++i)
            (y = e[i]) < 128 && F.push(S(y));
          for (n = a = F.length, a && F.push(m); n < P; ) {
            for (s = u, i = 0; i < P; ++i) (y = e[i]) >= t && y < s && (s = y);
            for (
              s - t > b((u - r) / (w = n + 1)) && x("overflow"),
                r += (s - t) * w,
                t = s,
                i = 0;
              i < P;
      ...
      function (e, t, r, f, h) {
        ...
        if (o(g)) {
          for (p = s(e.length); p > P; P++)
            if ((m = t ? y(i((d = e[P]))[0], d[1]) : y(e[P])) === c || m === l)
              return m;
        } else
    ...
    e.exports = {
      ...
      finalCleanUpCode: function (e, t) {
        ...
        r &&
          2 == r.length &&
          (e = t
            ? e.replace(v, "").replace(y, P)
            : e.replace(d, "").replace(m, g));
    ...
    (i = function (e) {
      ...
      (v.prototype.eos = function () {
        ...
        (m.prototype.lookup = function (e) {
          ...
          if (r.hasOwnProperty(e)) t = r[e];
            ...
            for (var a, i, s = this, u = !1; s; ) {
              if (e.indexOf(".") > 0)
                for (
                  t = s.view, a = e.split("."), i = 0;
                  null != t && i < a.length;

                )
                  i === a.length - 1 && (u = o(t, a[i])), (t = t[a[i++]]);
              ...
              (i = o[t] =
                (function (t, n) {
                  ...
                  var o,
                    ...
                    P = !1;
                  function w() {
                    if (y && !P) for (; g.length; ) delete m[g.pop()];
                    else g = [];
                    (y = !1), (P = !1);
                  }
                  function E(e) {
                  ...
                  for (var b, S, x, _, F, O, R = new v(t); !R.eos(); ) {
                    if (((b = R.pos), (x = R.scanUntil(o))))
                      for (var A = 0, I = x.length; A < I; ++A)
                        u((_ = x.charAt(A))) ? g.push(m.length) : (P = !0),
                          m.push(["text", _, b, b + 1]),
                          (b += 1),
                          "\n" === _ && w();
                    if (!R.scan(o)) break;
                    if (
                      ...
                      R.scan(l),
                      "=" === S
                        ? ((x = R.scanUntil(h)), R.scan(h), R.scanUntil(i))
                        : "{" === S
                        ? ((x = R.scanUntil(s)),
                          R.scan(p),
                          R.scanUntil(i),
                  ...
                  if ((O = c.pop()))
                    throw new Error(
                      'Unclosed section "' + O[1] + '" at ' + R.pos
                    );
                  return (function (e) {
                    for (
                      var t, r = [], n = r, a = [], o = 0, i = e.length;
                      o < i;
                      ++o
                    )
                      switch ((t = e[o])[0]) {
        ...
        (g.prototype.renderTokens = function (e, t, r, n) {
          for (var a, o, i, s = "", u = 0, c = e.length; u < c; ++u)
            (i = void 0),
              "#" === (o = (a = e[u])[0])
                ? (i = this.renderSection(a, t, r, n))
                : "^" === o
                ? (i = this.renderInverted(a, t, r, n))
                : ">" === o
                ? (i = this.renderPartial(a, t, r, n))
                : "&" === o
                ? (i = this.unescapedValue(a, t))
                : "name" === o
                ? (i = this.escapedValue(a, t))
                : "text" === o && (i = this.rawValue(a)),
              void 0 !== i && (s += i);
          return s;
        }),
          ...
          if (u) {
            if (r(u))
              for (var c = 0, l = u.length; c < l; ++c)
                s += this.renderTokens(e[4], t.push(u[c]), a, o);
            else if (
              "object" == typeof u ||
              "string" == typeof u ||
              "number" == typeof u
            )
              s += this.renderTokens(e[4], t.push(u), a, o);
            else if (n(u)) {
              if ("string" != typeof o)
                throw new Error(
        ...
        (g.prototype.renderInverted = function (e, t, n, a) {
          var o = t.lookup(e[1]);
          if (!o || (r(o) && 0 === o.length))
            return this.renderTokens(e[4], t, n, a);
        }),
        (g.prototype.renderPartial = function (e, t, r) {
          if (r) {
            var a = n(r) ? r(e[1]) : r[e[1]];
            return null != a
              ? this.renderTokens(this.parse(a), t, r, a)
              : void 0;
          }
        }),
      ...
      "object" == typeof t && t && "string" != typeof t.nodeName
        ? i(t)
        : ((a = [t]),
          void 0 === (o = "function" == typeof (n = i) ? n.apply(t, a) : n) ||
            (e.exports = o));
  },
  function (e, t, r) {
    "use strict";
    ...
    e.exports = function (e, t, r, v, m, g) {
      ...
      if (
        ...
        O ||
          ...
          (E.constructor = P)),
          (F || R) && (S("delete"), S("has"), m && S("get")),
          (R || _) && S(w),
          g && E.clear && delete E.clear;
      } else
        (P = v.getConstructor(t, e, m, w)), i(P.prototype, r), (s.NEED = !0);
      return (
        p(P, e),
        (b[e] = P),
        a(a.G + a.W + a.F * (P != y), b),
  ...
  function (e, t, r) {
    ...
    e.exports = function e(t, r) {
      ...
      if (c && l) {
        ...
        for (i = 0; i < s; i++) if (!e(t[i], r[i])) return !1;
        return !0;
      }
      if (c != l) return !1;
      ...
      if (t instanceof Object && r instanceof Object) {
        ...
        for (i = 0; i < s; i++) if (!o.call(r, v[i])) return !1;
        for (i = 0; i < s; i++) if (!e(t[(u = v[i])], r[u])) return !1;
        return !0;
      }
      return !1;
    };
  ...
  function (e, t, r) {
    ...
    function u(e, t, r) {
      ...
      if ((n = n || this._schemas[r]) instanceof i)
        return p(n.schema, this._opts.inlineRefs)
          ? n.schema
      ...
      var a,
        ...
        l = c.call(this, t, r);
      return (
        l && ((a = l.schema), (t = l.root), (s = l.baseId)),
        a instanceof i
          ? (o = a.validate || e.call(this, a.schema, t, void 0, s))
          : void 0 !== a &&
            (o = p(a, this._opts.inlineRefs)
              ? a
    ...
    (e.exports = u),
      ...
      (u.ids = function (e) {
        var t = g(this._getId(e)),
          ...
          c = this;
        return (
          s(e, { allKeys: !0 }, function (e, t, s, l, f, h, p) {
            if ("" !== t) {
              var d = c._getId(e),
                v = r[l],
                m = i[l] + "/" + f;
              if (
                (void 0 !== p &&
                  (m += "/" + ("number" == typeof p ? p : o.escapeFragment(p))),
                "string" == typeof d)
              ) {
          ...
          ? (function e(t) {
              ...
              if (Array.isArray(t)) {
                for (var a = 0; a < t.length; a++)
                  if (
                    ("object" == typeof (r = t[a]) && (n += e(r)), n == 1 / 0)
                  )
                    return 1 / 0;
              } else
                for (var o in t) {
  ...
  function (e, t, r) {
    ...
    function M(e, t, r) {
      ...
      for (
        (e = F(e)) != e || e === x
          ...
          : ((n = R(A(e) / I)),
            e * (o = O(2, -n)) < 1 && (n--, (o *= 2)),
            (e += n + c >= 1 ? l / o : l * O(2, 1 - c)) * o >= 2 &&
              (n++, (o /= 2)),
            n + c >= u
              ? ((a = 0), (n = u))
              : n + c >= 1
              ? ((a = (e * o - 1) * O(2, t)), (n += c))
              : ((a = e * O(2, c - 1) * O(2, t)), (n = 0)));
        t >= 8;
        i[f++] = 255 & a, a /= 256, t -= 8
      );
    ...
    function Q(e, t, r, n, a, o) {
      ...
      for (var s = e[j]._b, u = i + e[$], c = n(+a), l = 0; l < t; l++)
        s[u + l] = c[o ? l : t - l - 1];
    }
    if (i.ABV) {
      if (
    ...
    (h && p) ||
      ...
      "process" == r(19)(f)
        ...
        ? ((n = function (e) {
          ...
          l.addEventListener("message", P, !1))
        : (n =
    ...
    e.exports = function (e, t, r, d, v, m, g) {
      ...
      if (
        (A &&
          ...
          w.next &&
          (c(w, b, !0), n || "function" == typeof w[f] || i(w, f, p)),
        S &&
          F &&
          "values" !== F.name &&
          ((x = !0),
      ...
      if (m) {
        ...
        (a = _.pop()),
          ...
          (a +=
            ...
            "='; "),
          void 0 === s &&
            ((P = d), (c = e.errSchemaPath + "/" + d), (n = w), (h = m));
      } else {
        x = g;
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r) {
      ...
      if (e.isTop) {
        ...
        if ((i && (e.baseId = e.resolve.url(e.baseId, i)), a && !e.async))
        ...
        if (b || E || !0 === S || (S && !Y(S))) {
          ...
          if (((n += " if (" + e.util[x](w, p, !0) + ") { "), b)) {
            ...
            var O = "",
              R = b;
            if (R)
              for (var A, I = -1, j = R.length - 1; I < j; )
                (A = R[(I += 1)]),
                  I && ((n += " if (" + F + " === undefined) { "), (O += "}")),
                  "array" == e.opts.coerceTypes &&
                    "array" != A &&
                    (n +=
                      " if (" +
        ...
        if (M)
          for (var k = -1, C = M.length - 1; k < C; )
            if (Y((S = M[(k += 1)]))) {
              if (
                (S.type &&
                  (n += " if (" + e.util.checkDataType(S.type, p) + ") { "),
                ...
                if ("object" == S.type && e.schema.properties) {
                  ...
                  if (T)
                    for (var L, N = -1, V = T.length - 1; N < V; ) {
                      if (void 0 !== (z = c[(L = T[(N += 1)])]).default)
                        (n +=
                          "  if (" +
                          (Q = p + e.util.getProperty(L)) +
                          " === undefined) " +
                          Q +
                          " = "),
                          "shared" == e.opts.useDefaults
                            ? (n += " " + e.useDefault(z.default) + " ")
                            : (n += " " + JSON.stringify(z.default) + " "),
                          (n += "; ");
                    }
        ...
        m
          ? (a
              ...
              : ((n += " validate.errors = vErrors; "),
                (n += " return errors === 0;       ")),
            (n += " }; return validate;"))
          : (n += " var " + d + " = errors === errs_" + s + ";"),
        (n = e.util.cleanUpCode(n)),
        m && (n = e.util.finalCleanUpCode(n, a)),
        n
      );
    };
  },
  ...
  function (e, t, r) {
    ...
    e.exports = function (e) {
      return function (t) {
        for (var r, i = a(t), s = n(i), u = s.length, c = 0, l = []; u > c; )
          o.call(i, (r = s[c++])) && l.push(e ? [r, i[r]] : i[r]);
        return l;
      };
    };
  },
      ...
      for (var d, v, m = l, g = 0, y = !!h && i(h, p, 3); g < c; ) {
        if (g in u) {
          if (
            ((d = y ? y(u[g], g, r) : u[g]),
            (v = !1),
            a(d) && (v = void 0 !== (v = d[s]) ? !!v : n(d)),
            v && f > 0)
          )
            m = e(t, r, d, o(d.length), m, f - 1) - 1;
          else {
  ...
  function (e, t, r) {
    r(8) &&
      "g" != /./g.flags &&
      r(7).f(RegExp.prototype, "flags", { configurable: !0, get: r(59) });
  },
  function (e, t) {
    e.exports = function (e, t) {
    ...
    e.exports =
      ...
      function (e, t) {
        ...
        for (
          ...
          u in r ? (r[s] = r[u]) : delete r[s], (s += f), (u += f);
        return r;
      };
  },
  function (e, t, r) {
  ...
  function (e, t, r) {
    ...
    e.exports =
      ...
      r(3)(function () {
        ...
        ? function (e, t) {
            for (
              var r = i(e), u = arguments.length, c = 1, l = a.f, f = o.f;
              u > c;
  ...
  function (e, t, r) {
    ...
    e.exports = r(8)
      ...
      : function (e, t) {
          a(e);
          for (var r, i = o(t), s = i.length, u = 0; s > u; )
            n.f(e, (r = i[u++]), t[r]);
          return e;
        };
  },
  ...
  function (e, t, r) {
    e.exports =
      ...
      !r(3)(function () {
        return (
          7 !=
          Object.defineProperty(r(95)("div"), "a", {
            get: function () {
              return 7;
            },
          }).a
  ...
  function (e, t, r) {
    ...
    function x(e, t = {}) {
      ...
      if (
        ...
        let r = e.path;
        t.absolutePath || (a && a.absolutePath) || (r = S(r)),
          void 0 === o && (r = r.replace(/^\/\//, "/%2F")),
          n.push(r);
      }
      return (
    ...
    function I(e, t) {
      return (
        e && e.toString().replace(t && t.iri ? c.PCT_ENCODED : u.PCT_ENCODED, d)
      );
    }
    var j = {
        scheme: "http",
    ...
    const $ = {},
      M =
        "[A-Za-z0-9\\-\\.\\_\\~\\xA0-\\u200D\\u2010-\\u2029\\u202F-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF]",
      k = a(
        a("%[EFef][0-9A-Fa-f]%[0-9A-Fa-f][0-9A-Fa-f]%[0-9A-Fa-f][0-9A-Fa-f]") +
          "|" +
          a("%[89A-Fa-f][0-9A-Fa-f]%[0-9A-Fa-f][0-9A-Fa-f]") +
          "|" +
          a("%[0-9A-Fa-f][0-9A-Fa-f]")
      ),
      C = "[A-Za-z0-9\\!\\$\\%\\'\\*\\+\\-\\^\\_\\`\\{\\|\\}\\~]",
      T = "[\\!\\$\\%\\'\\(\\)\\*\\+\\,\\-\\.0-9\\<\\>A-Z\\x5E-\\x7E]",
      L = n(T, '[\\"\\\\]'),
    ...
    var te = {
      ...
      parse: function (e, t) {
        ...
        for (let n = 0, a = r.length; n < a; ++n) {
          const a = r[n].split("@");
          if (((a[0] = I(a[0])), t.unicodeSupport))
            a[1] = I(a[1], t).toLowerCase();
          else
            try {
      ...
      serialize: function (e, t) {
        ...
        for (const e in a)
          a[e] !== $[e] &&
            o.push(
              e.replace(J, ee).replace(J, i).replace(Z, p) +
                "=" +
                a[e].replace(J, ee).replace(J, i).replace(X, p)
            );
    ...
    var ie = {
      ...
      serialize: function (e, t) {
        ...
        if (r && "urn" !== r) {
          ...
          (e.scheme = "urn"),
            (e.path = t[1] + ":" + (e.path ? e.path.replace(oe, p) : ""));
        }
        return e;
      },
    };
    ...
    var ue = {
      ...
      serialize: function (e, t) {
        return (
          t.tolerant || (e.path && e.path.match(se))
  ...
  function (e) {
    e.exports = {
      ...
      type: "object",
      properties: {
        model: { description: "URLID of a Sketchfab model", type: "string" },
        params: { description: "Embed parameters", type: "object" },
        config: {
      ...
      definitions: {
        namedColor: {
          ...
          properties: {
            ...
            color: { description: "Hexadecimal RGB color", type: "string" },
          },
          required: ["name", "color"],
        },
        predefinedTexture: {
          ...
          properties: {
            name: { description: "Human readable name", type: "string" },
            url: { description: "Image URL", type: "string" },
          },
          required: ["name", "url"],
        },
        modelPart: {
        ...
        visibleOption: {
          ...
          type: "object",
          properties: {
            name: { description: "Human readable option name", type: "string" },
            type: {
            ...
            default: { description: "Default value", type: "boolean" },
          },
        ...
        selectOption: {
          ...
          properties: {
            ...
            options: {
              ...
              type: "array",
              items: { anyOf: [{ $ref: "#/definitions/modelPart" }] },
            },
            default: { description: "Default value index", type: "integer" },
          },
          required: ["name", "type"],
        },
        textureOption: {
          ...
          properties: {
            ...
            options: {
              ...
              type: "array",
              items: { anyOf: [{ $ref: "#/definitions/predefinedTexture" }] },
            },
            default: { description: "Default value index", type: "integer" },
          },
          required: ["name", "type"],
  ...
  function (e, t, r) {
    ...
    (i.prototype = {
      template:
        '\n  <div  for="{{id}}" class="form-check mt-3">\n        <input type="checkbox" class="form-check-input" selector="{{option.selector}}" {{option.disabled}} data-option="{{index}}" id="{{id}}" {{#value}}checked{{/value}}>\n     <label class="form-check-label" for="defaultRadio1"> {{option.name}} </label> </div>\n    ',
  ...
  function (e, t, r) {
    ...
    (i.prototype = {
      template:
        '\n    <label for="{{id}}">{{option.name}}</label>\n    <div class="mb-3">\n        <select class="form-select" aria-label="Default select example" id="{{id}}" data-option="{{index}}" value="{{value}}">\n            {{#options}}\n                <option value="{{index}}" {{#isSelected}}selected{{/isSelected}}>{{name}}</option>\n            {{/options}}\n        </select>\n    </div>\n    ',
      _generateId: function () {
        return "control_" + Math.floor(1e4 * Math.random());
      },
      render: function () {
        if (!this.el) {
          ...
          var e = this.model.getOptionValue(this.index),
            t = this.model.options[this.index].options.map(function (t, r) {
              return Object.assign({}, t, { index: r, isSelected: r === e });
            }),
            r = o.default.render(this.template, {
              id: this.index,
              index: this.index,
      ...
      render: function () {
        if (!this.el) {
          ...
          var e = this.model.getOptionValue(this.index),
            t = void 0;
          t =
            void 0 !== this.model.options[this.index].options
              ? this.model.options[this.index].options.map(function (t, r) {
                  return Object.assign({}, t, {
    ...
    u.prototype = {
      initialize: function () {
        (this.handleOptionChange = this.handleOptionChange.bind(this)),
          this.el.addEventListener("change", this.handleOptionChange, !1);
        for (
          var e,
            t = {
              color: n.default,
            ...
            r = 0,
            s = this.model.options.length;
          r < s;
          r++
        )
          (e = new t[this.model.options[r].type](this.model, r)).render(),
            this.subviews.push(e),
            this.el.appendChild(e.el);
      },
      dispose: function () {
        this.el.removeEventListener("change", this.handleOptionChange, !1),
          (this.el.innerHTML = "");
      },
      _generateId: function () {
        return "control_" + Math.floor(1e4 * Math.random());
  ...
  function (e, t, r) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (n.prototype = {
        initialize: function () {
          for (var e = 0, t = this.options.length; e < t; e++)
            switch (this.options[e].type) {
              case "visible":
              ...
              case "color":
                ...
                break;
              case "select":
                this.options[e].default
                  ? this.setOptionValue(e, this.options[e].default)
                  : this.setOptionValue(e, 0);
                break;
              case "texture":
                this.setOptionValue(e, this.options[e].default);
            }
        ...
        setOptionValue: function (e, t) {
          ...
          ("select" !== r.type && "texture" !== r.type) ||
            (t = parseInt(t, 10)),
            "visible" === r.type && (t = Boolean(t)),
            (this.values[e] = t),
            this[
              {
        ...
        applyOptionVisible: function (e, t) {
          ...
          if (e === 8) {
            // Seleccionamos el check de solar panel
            var solarPanel = document.getElementById("7");
            if (solarPanel) {
              if (!t) {
                solarPanel.disabled = false; // Habilitamos el checkbox con id 'solar panel'
              } else {
                solarPanel.disabled = true; // Deshabilita el checkbox con id 'solar panel'
                solarPanel.checked = false;
                var selectorValue = solarPanel.getAttribute("selector");
                this.viewer.hide(selectorValue);
              }
            }
          }
        ...
        applyOptionTexture: function (e, t) {
          ...
          for (var n = 0, a = r.options.length; n < a; n++)
            n === t &&
              this.viewer.setTexture(r.material, r.channels, r.options[n].url);
        },
      });
  },
  function (e, t, r) {
    ...
    (t.srgbToLinear = function (e, t) {
      ...
      if (!(e.length > 2 && e.length < 5))
        throw new Error(
          "Invalid color. Expected 3 or 4 components, but got " + e.length
        );
      return (
        (r[0] = a(e[0])),
        (r[1] = a(e[1])),
    ...
    a.prototype = {
      start: function () {
        var e = new Sketchfab(this.iframe),
          ...
          r = Object.assign({}, { graph_optimizer: 0 }, t, {
      ...
      _getGraph: function () {
        return (
          this.api || Promise.reject("getGraph: API not ready"),
          new Promise(
            function (e, t) {
      ...
      _getMaterials: function () {
        return (
          this.api || Promise.reject("getMaterials: API not ready"),
          new Promise(
            function (e, t) {
      ...
      _getMaterialByName: function (e) {
        return this.materials
          ? this.materials.reduce(function (t, r) {
              return r.name === e ? r : t;
            }, null)
          : null;
      },
      _renderGraphNode: function (e, t) {
        ...
        if (
          (r.setAttribute("instance", t.instanceID),
          t.name && r.setAttribute("name", t.name),
          t.children && t.children.length)
        )
          for (var n = 0, a = t.children.length; n < a; n++)
            r.appendChild(this._renderGraphNode(e, t.children[n]));
        return r;
      },
      ...
      show: function (e) {
        this.api
          ? this._getInstanceIDsFromSelector(e).forEach(
              function (e) {
                this.api.show(e);
              }.bind(this)
            )
      ...
      _setMaterialColor: function (e, t) {
        ...
        (r.channels.AlbedoPBR.color = a),
          (r.channels.DiffusePBR.color = a),
          (r.channels.DiffuseColor.color = a),
          (r.channels.AlbedoPBR.texture = null),
          (r.channels.DiffusePBR.texture = null),
          (r.channels.DiffuseColor.texture = null),
          this.api.setMaterial(r, function (e, t) {
            e && console.error(e);
          });
      },
      ...
      _setMaterialTexture: function (e, t, r) {
        ...
        this._addTexture(r).then(function (e) {
          ...
          for (var r = 0; r < t.length; r++)
            a.channels.hasOwnProperty(t[r]) && a.channels[t[r]].texture
              ? (a.channels[t[r]].texture.uid = e)
              : (a.channels[t[r]].texture = {
                  internalFormat: "RGB",
                  magFilter: "LINEAR",
      ...
      _addTexture: function (e) {
        ...
        return new Promise(function (r, n) {
          t.textures.hasOwnProperty(e)
            ? r(t.textures[e])
            : t.api.addTexture(e, function (a, o) {
        ...
        : function (e, t) {
            return (
              ...
              new Promise(function (r, n) {
                ...
                for (var o in (a.open(t.method || "get", e), t.headers))
                  a.setRequestHeader(o, t.headers[o]);
                function i() {
                  var e,
                    t = [],
                    r = [],
                  ...
                  return (
                    a
                      ...
                      .replace(/^(.*?):\s*([\s\S]*?)$/gm, function (a, o, i) {
        ...
        return (
          ...
          (function e(t) {
            try {
              ...
              if (e instanceof n)
                return (function a(e) {
                  ...
                  i ||
                    (i = o._loadingSchemas[a] = o._opts.loadSchema(a)).then(
                      u,
                      u
                    );
                  return i
                    ...
                    .then(function () {
                      return (function e(t) {
                        ...
                        function a(n) {
                          ...
                          return (
                            i ||
                              (i = o._loadingSchemas[a] =
                                o._opts.loadSchema(a)).then(u, u),
                            i
                              .then(function (e) {
                                if (!c(a))
                                  return s(e).then(function () {
            ...
            function a(n) {
              ...
              return (
                i ||
                  (i = o._loadingSchemas[a] = o._opts.loadSchema(a)).then(u, u),
                i
                  .then(function (e) {
                    if (!c(a))
                      return s(e).then(function () {
        ...
        if (c)
          if (((n += " var missing" + a + "; "), E)) {
                ...
                ? ((n +=
                  ...
                  !1 !== e.opts.messages &&
                    ...
                    e.opts._errorDataPathProperty
                      ...
                      : (n += "should have required property \\'" + S + "\\'"),
                    (n += "' ")),
                  e.opts.verbose &&
                    (n +=
                      " , schema: validate.schema" +
            ...
            (n = R.pop()),
              !e.compositeRule && c
                ? e.async
                  ? (n += " throw new ValidationError([" + x + "]); ")
                  : (n += " validate.errors = [" + x + "]; return false; ")
                : (n +=
                    " var err = " +
                    x +
                    ";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; "),
              ...
              for (var F = -1, O = _.length - 1; F < O; ) {
                (j = _[(F += 1)]),
                  ...
                  (n +=
                    ...
                    a +
                    " = " +
                    e.util.toQuotedString(e.opts.jsonPointers ? j : M) +
                    ") ) ");
              }
            n += ") {  ";
            var R;
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r) {
      ...
      if (e.util.schemaHasRules(i, e.RULES.all)) {
        ...
        var x = e.validate(h);
        (h.baseId = E),
          e.util.varOccurences(x, y) < 2
            ? (n += " " + e.util.varReplace(x, y, b) + " ")
            : (n += " var " + y + " = " + b + "; " + x + " "),
          (e.compositeRule = h.compositeRule = S),
          (n +=
            " if (!" +
            p +
            ") { for (var " +
      ...
      return (
        c && (n += "  if (" + f + " == errors) {"), (n = e.util.cleanUpCode(n))
      );
    };
  },
  function (e, t, r) {
        ...
        if (
          ...
          if (((n += " var isAdditional" + a + " = !(false "), w.length))
            if (w.length > 8)
              ...
              var $ = w;
              if ($)
                for (var M = -1, k = $.length - 1; M < k; )
                  (W = $[(M += 1)]),
                    (n += " || " + v + " == " + e.util.toQuotedString(W) + " ");
            }
          if (b.length) {
            var C = b;
            if (C)
              for (var T = -1, L = C.length - 1; T < L; )
                (ae = C[(T += 1)]),
          ...
          if (
            ...
            if (O) n += " delete " + l + "[" + v + "]; ";
              ...
              (n = te.pop()),
                !e.compositeRule && c
                  ? e.async
                    ? (n += " throw new ValidationError([" + z + "]); ")
                    : (n += " validate.errors = [" + z + "]; return false; ")
                  : (n +=
                      " var err = " +
                      z +
                      ";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; "),
        ...
        if (G)
          for (var W, K = -1, J = G.length - 1; K < J; ) {
            ...
            if (e.util.schemaHasRules(Y, e.RULES.all)) {
              ...
              (h.schema = Y),
                (h.schemaPath = s + Z),
                (h.errSchemaPath = u + "/" + e.util.escapeFragment(W)),
                (h.errorPath = e.util.getPath(
                  e.errorPath,
                  W,
                  e.opts.jsonPointers
                )),
                (h.dataPathArr[g] = e.util.toQuotedString(W));
              H = e.validate(h);
        ...
        if (ne)
          for (var ae, oe = -1, ie = ne.length - 1; oe < ie; ) {
            ...
            if (e.util.schemaHasRules(Y, e.RULES.all)) {
              (h.schema = Y),
                (h.schemaPath =
                  e.schemaPath + ".patternProperties" + e.util.getProperty(ae)),
                (h.errSchemaPath =
                  e.errSchemaPath +
                  "/patternProperties/" +
      ...
      d.push(a),
        ...
        !1 !== e.createErrors
          ? ((a +=
              ...
              e.util.toQuotedString(c) +
              " , params: { pattern:  "),
            (a += h ? "" + n : "" + e.util.toQuotedString(s)),
            (a += "  } "),
            !1 !== e.opts.messages &&
              ((a += " , message: 'should match pattern \""),
              (a += h ? "' + " + n + " + '" : "" + e.util.escapeQuotes(s)),
              (a += "\"' ")),
            e.opts.verbose &&
              ((a += " , schema:  "),
              (a += h ? "validate.schema" + u : "" + e.util.toQuotedString(s)),
              (a +=
                "         , parentSchema: validate.schema" +
                e.schemaPath +
                " , data: " +
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r) {
      ...
      var w = i;
      if (w)
        for (var E, b = -1, S = w.length - 1; b < S; )
          (E = w[(b += 1)]),
      ...
      if (h) {
        (n +=
          ...
          "ignore" != p &&
            ((n += " (" + f + " && !" + v + " "),
            d &&
              (n += " && self._opts.unknownFormats.indexOf(" + f + ") == -1 "),
            (n += ") || ")),
          (n +=
            " (" +
            v +
        ...
        var m,
          g =
            ((m =
              "object" == typeof v && !(v instanceof RegExp) && v.validate) &&
              v.type) ||
            "string";
        if (m) {
          var y = !0 === v.async;
      ...
      w.push(n),
        ...
        !1 !== e.createErrors
          ? ((n +=
              ...
              e.util.toQuotedString(u) +
              " , params: { format:  "),
            (n += h ? "" + f : "" + e.util.toQuotedString(i)),
            (n += "  } "),
            !1 !== e.opts.messages &&
              ((n += " , message: 'should match format \""),
              (n += h ? "' + " + f + " + '" : "" + e.util.escapeQuotes(i)),
              (n += "\"' ")),
            e.opts.verbose &&
              ((n += " , schema:  "),
              (n += h ? "validate.schema" + s : "" + e.util.toQuotedString(i)),
              (n +=
                "         , parentSchema: validate.schema" +
                e.schemaPath +
                " , data: " +
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r) {
      ...
      for (var E in ((n += "var missing" + a + ";"), m))
        if ((P = m[E]).length) {
          if (
            ((n += " if ( " + l + e.util.getProperty(E) + " !== undefined "),
            g &&
              (n +=
                " && Object.prototype.hasOwnProperty.call(" +
                l +
              ...
              !1 !== e.createErrors
                ? ((n +=
                  ...
                  !1 !== e.opts.messages &&
                    ...
                    1 == P.length
                      ? (n += "property " + e.util.escapeQuotes(P[0]))
                      : (n +=
      ...
      for (var E in v) {
        ...
        e.util.schemaHasRules(y, e.RULES.all) &&
          ...
          (n += ") { "),
          (h.schema = y),
          (h.schemaPath = s + e.util.getProperty(E)),
          (h.errSchemaPath = u + "/" + e.util.escapeFragment(E)),
          (n += "  " + e.validate(h) + " "),
          (h.baseId = k),
          (n += " }  "),
          c && ((n += " if (" + d + ") { "), (p += "}")));
    ...
    e.exports = function (e, t, r) {
      ...
      h &&
        (n +=
          ...
          e.util.getData(i.$data, o, e.dataPathArr) +
          "; "),
        h || (n += " var schema" + a + " = validate.schema" + s + ";"),
        (n +=
          "var " +
          f +
          " = equal(" +
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r) {
      ...
      if (
        ...
        var y = i;
        if (y)
          for (var P, w = -1, E = y.length - 1; w < E; )
            (P = y[(w += 1)]),
              (p.schema = P),
              (p.schemaPath = s + "[" + w + "]"),
              (p.errSchemaPath = u + "/" + w),
      ...
      return (
        ...
        e.forEach(function (r) {
          (r.rules = r.rules.map(function (r) {
            ...
            return (
              t.push(r), (e.all[r] = { keyword: r, code: n[r], implements: a })
            );
          })),
          ...
          if (a && "object" == typeof a && !Array.isArray(a))
            for (var f in (r(a, o, i, s, u, c, l), a)) {
              ...
              if (Array.isArray(h)) {
                ...
                (f in n.keywords || (t.allKeys && !(f in n.skipKeywords))) &&
                  e(t, r, h, o + "/" + f, i, o, f, a);
            }
        })(t, r, e, "", e);
    });
  ...
  function (e, t, r) {
    ...
    function h(e, t) {
      return (
        "var pattern" + e + " = new RegExp(" + a.toQuotedString(t[e]) + ");"
      );
    }
    function p(e) {
    ...
    e.exports = function e(t, r, g, y) {
      var P = this,
        ...
        F = {},
        O = [];
      r = r || { schema: t, refVal: E, refs: b };
      var R = function (e, t, r) {
        var n = f.call(this, e, t, r);
        return n >= 0
          ? { index: n, compiling: !0 }
          : ((n = this._compilations.length),
            (this._compilations[n] = { schema: e, root: t, baseId: r }),
            { index: n, compiling: !1 });
      }.call(this, t, r, y);
      ...
      function M(t, i, f, g) {
        ...
        (R = m(E, d) + m(S, h) + m(_, p) + m(O, v) + R),
          w.processCode && (R = w.processCode(R));
        try {
          var A = new Function(
            "self",
            "RULES",
          ...
          throw (
            (P.logger.error("Error compiling schema, function code:", R), e)
          );
        }
        return (
          (x.schema = t),
          ...
          F && (x.$async = !0),
          !0 === w.sourceCode &&
            (x.source = { code: R, patterns: S, defaults: _ }),
          x
        );
      }
      function k(t, a, o) {
        ...
        switch (typeof e) {
          ...
          case "object":
            ...
            var t = i(e),
              r = F[t];
            return (
              void 0 === r && ((r = F[t] = _.length), (_[r] = e)), "default" + r
            );
        }
      }
      function V(e, t, r, n) {
        ...
        if (u) s = u.call(P, t, r, n);
          ...
          (s = l.call(P, t, r, n)),
            !1 !== w.validateSchema && P.validateSchema(s, !0);
        ...
        var f = O.length;
        return (O[f] = s), { code: "customRule" + f, validate: s };
      }
    };
  },
  function (e, t, r) {
    ...
    (e.exports = g),
      ...
      (g.prototype._addSchema = function (e, t, r, n) {
        ...
        f &&
          !(l = c && c == a.normalizeId(e.$schema)) &&
          this.validateSchema(e, !0);
        var h = a.ids.call(this, e),
          p = new i({ id: c, schema: e, localRefs: h, cacheKey: s, meta: r });
    ...
    var p = r(66);
    (g.ValidationError = p.Validation),
      (g.MissingRefError = p.MissingRef),
      (g.$dataMetaSchema = l);
    ...
    function g(e) {
      ...
      (e = this._opts = f.copy(e) || {}),
        (function (e) {
          ...
          if (!1 === t) e.logger = { log: x, warn: x, error: x };
          else {
            if (
              (void 0 === t && (t = console),
      ...
      (this._schemaUriFormatFunc = function (e) {
        ...
        (this._metaOpts = (function (e) {
          for (var t = f.copy(e._opts), r = 0; r < v.length; r++)
            delete t[v[r]];
          return t;
        })(this)),
        e.formats &&
    ...
    function y(e, t) {
      return (
        (t = a.normalizeId(t)), e._schemas[t] || e._refs[t] || e._fragments[t]
      );
    }
    function P(e, t, r) {
      for (var n in t) {
            ...
            (l.mark = function (e) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((e.__proto__ = x), u in e || (e[u] = "GeneratorFunction")),
  ...
  function (e, t, r) {
    var n = r(0);
    n(n.P + n.R, "Set", { toJSON: r(106)("Set") });
  },
  function (e, t, r) {
    var n = r(0);
    n(n.P + n.R, "Map", { toJSON: r(106)("Map") });
  },
  function (e, t, r) {
    "use strict";
    var n = r(0),
    ...
    r(8) &&
      n(n.P + r(54), "Object", {
        __defineSetter__: function (e, t) {
          i.f(a(this), e, { set: o(t), enumerable: !0, configurable: !0 });
        },
      });
  },
  function (e, t, r) {
    ...
    r(8) &&
      n(n.P + r(54), "Object", {
        __defineGetter__: function (e, t) {
          i.f(a(this), e, { get: o(t), enumerable: !0, configurable: !0 });
        },
      });
  },
  function (e, t, r) {
  ...
  function (e, t, r) {
    ...
    n(n.S, "Object", {
      getOwnPropertyDescriptors: function (e) {
        for (
          var t, r, n = o(e), u = i.f, c = a(n), l = {}, f = 0;
          c.length > f;
      ...
      set: function e(t, r, s) {
        ...
        return i(d, "value")
          ? !(
              !1 === d.writable ||
              !l(p) ||
              (((f = a.f(p, r) || u(0)).value = s), n.f(p, r, f), 0)
            )
          : void 0 !== d.set && (d.set.call(p, s), !0);
      },
    });
  },
  function (e, t, r) {
  ...
  function (e, t, r) {
    var n = r(0);
    n(n.G + n.W + n.F * !r(55).ABV, { DataView: r(70).DataView });
  },
  function (e, t, r) {
    "use strict";
    var n = r(0),
        ...
        n = function (e, t) {
          ...
          for (
            ...
            !(
              ...
              u.length > 1 && u.index < r.length && i.apply(h, u.slice(1)),
              (l = u[0].length),
              (d = c),
              h.length >= v)
            );
  ...
  function (e, t, r) {
    var n = r(0);
    n(n.P, "Array", { fill: r(75) }), r(29)("fill");
  },
  function (e, t, r) {
    var n = r(0);
    n(n.P, "Array", { copyWithin: r(121) }), r(29)("copyWithin");
  },
  function (e, t, r) {
    "use strict";
    var n = r(0),
    ...
    n(
      ...
      "Array",
      {
        slice: function (e, t) {
          ...
          for (
            var a = i(e, r), c = i(t, r), l = s(c - a), f = new Array(l), h = 0;
            h < l;
            h++
          )
            f[h] = "String" == n ? this.charAt(a + h) : this[a + h];
          return f;
        },
      }
    );
      ...
      "Array",
      {
        from: function (e) {
          var t,
            ...
            y = l(h);
          if (
            (m && (v = n(v, d > 2 ? arguments[2] : void 0, 2)),
            void 0 == y || (p == Array && s(y)))
          )
            for (r = new p((t = u(h.length))); t > g; g++)
              c(r, g, m ? v(h[g], g) : h[g]);
          else
            for (f = y.call(h), r = new p(); !(a = f.next()).done; g++)
              c(r, g, m ? i(f, v, [a.value, g], !0) : a.value);
          return (r.length = g), r;
        },
      }
    );
  ...
  function (e, t, r) {
    ...
    n(n.S, "Math", {
      hypot: function (e, t) {
        for (var r, n, o = 0, i = 0, s = arguments.length, u = 0; i < s; )
          u < (r = a(arguments[i++]))
            ? ((o = o * (n = u / r) * n + 1), (u = r))
            : (o += r > 0 ? (n = r / u) * n : r);
  ...
  function (e, t, r) {
    ...
    var n = r(0),
      ...
      f = function (e, t) {
        for (var r = -1, n = t; ++r < 6; )
          (n += e * c[r]), (c[r] = n % 1e7), (n = u(n / 1e7));
      },
      h = function (e) {
        for (var t = 6, r = 0; --t >= 0; )
          (r += c[t]), (c[t] = u(r / e)), (r = (r % e) * 1e7);
      },
      p = function () {
        for (var e = 6, t = ""; --e >= 0; )
          if ("" !== t || 0 === e || 0 !== c[e]) {
  ...
  function (e, t, r) {
    var n = r(0);
    n(n.S, "Object", { is: r(367) });
  },
  function (e, t, r) {
    var n = r(0);
    n(n.S + n.F, "Object", { assign: r(132) });
  },
  function (e, t, r) {
    var n = r(4);
  ...
  function (e, t, r) {
    var n = r(0);
    n(n.S + n.F * !r(8), "Object", { defineProperties: r(134) });
  },
  function (e, t, r) {
    var n = r(0);
    n(n.S + n.F * !r(8), "Object", { defineProperty: r(7).f });
  },
  function (e, t, r) {
    var n = r(0);
  ...
  function (e, t, r) {
    ...
    e.exports = function (e) {
      var t = n(e),
        r = a.f;
      if (r)
        for (var i, s = r(e), u = o.f, c = 0; s.length > c; )
  ...
  function (e, t, r) {
    ...
    var n = r(2),
      ...
      G = function (e, t, r) {
        return (
          ...
          a(L, t)
            ? (r.enumerable
                ? (a(e, M) && e[M][t] && (e[M][t] = !1),
                  (r = S(r, { enumerable: b(0, !1) })))
                : (a(e, M) || A(e, M, b(1, {})), (e[M][t] = !0)),
              Q(e, t, r))
            : A(e, t, r)
        );
      },
      W = function (e, t) {
        y(e);
        for (var r, n = m((t = w(t))), a = 0, o = n.length; o > a; )
          G(e, (r = n[a++]), t[r]);
        return e;
      },
      K = function (e) {
        ...
        return (
          !(this === V && a(L, e) && !a(N, e)) &&
          (!(t || !a(this, e) || !a(L, e) || (a(this, M) && this[M][e])) || t)
        );
      },
      J = function (e, t) {
        if (((e = w(e)), (t = E(t, !0)), e !== V || !a(L, t) || a(N, t))) {
          var r = R(e, t);
          return (
            !r || !a(L, t) || (a(e, M) && e[M][t]) || (r.enumerable = !0), r
          );
        }
      },
      Y = function (e) {
        for (var t, r = I(w(e)), n = [], o = 0; r.length > o; )
          a(L, (t = r[o++])) || t == M || t == u || n.push(t);
        return n;
      },
      Z = function (e) {
        for (
          var t, r = e === V, n = I(r ? N : w(e)), o = [], i = 0;
          n.length > i;

        )
          !a(L, (t = n[i++])) || (r && !a(V, t)) || o.push(L[t]);
        return o;
      };
    U ||
      (s(
        (j = function () {
          ...
          return o && q && Q(V, e, { configurable: !0, set: t }), H(e);
        }).prototype,
        "toString",
        function () {
          return this._k;
      ...
      (r(49).f = K),
      (r(63).f = Z),
      o && !r(40) && s(V, "propertyIsEnumerable", K, !0),
      (d.f = function (e) {
        return H(p(e));
      })),
  ...
  function (e, t, r) {
    "use strict";
    (function (e) {
      if ((r(385), r(188), r(187), e._babelPolyfill))
        throw new Error("only one instance of babel-polyfill is allowed");
      e._babelPolyfill = !0;
      var t = "defineProperty";
      function n(e, r, n) {
        e[r] || Object[t](e, r, { writable: !0, configurable: !0, value: n });
      }
        ...
        function e(t, r) {
          ...
          if (
            ...
            if (this.config) o = Promise.resolve(this.config);
              ...
              u.hasOwnProperty("config")
                ? (console.log("Loading config from URL", u.config),
                  (o = this.loadConfig(u.config)))
                : window.defaultConfigUrl
                ? (console.log(
                    "Loading default config URL",
                    window.defaultConfigUrl
                  ),
                  (o = this.loadConfig(window.defaultConfigUrl)))
                : window.defaultConfig
                ? (console.log("Loading config", window.defaultConfig),
                  (o = Promise.resolve(window.defaultConfig)))
                : (o = Promise.reject("No configuration found"));
            }
            o.then(function (e) {
              var t = n._validate(e);
              !1 === t.valid && console.warn(t.errors),
                (n.config = e),
                n.initialize();
            }).catch(function (e) {
              console.error(e);
            ...
            this.renderFatalError(
              "This page is for preview only and cannot be embedded."
            );
        }
        return (
          n(e, [
            {
              ...
              value: function () {
                ...
                this.viewer = new SketchfabConfigurator.Viewer(
                  ...
                  t.model,
                  function () {
                    e.optionView = new SketchfabConfigurator.OptionsView(
                      optionsEl,
                      new SketchfabConfigurator.Options(t.config, e.viewer)
                    );
                  },
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return t(e) ? { valid: !0 } : { valid: !1, errors: t.errors };
              },
            },
            {
              key: "dispose",
            ...
            },
            {
              key: "loadConfig",
              value: function (e) {
                return (0, o.default)(e, { method: "GET", mode: "cors" }).then(
                  function (e) {
                    return e.json();
                  }
                );
